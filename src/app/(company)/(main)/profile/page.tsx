...
export default function ProfilePage() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex items-center gap-4 px-5 py-4 rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] border backdrop-blur-md ${
            toast.type === "success"
        ...
        >
          <div
            className={`rounded-xl w-10 h-10 flex items-center justify-center shrink-0 shadow-sm ${
